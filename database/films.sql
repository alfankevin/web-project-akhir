...
insert into film values (20, "Peaky Blinders", "Subs", 6.6, "Drama", 2000, 16, "2.png", "https://www.youtube.com/embed/2nsT9uQPIrk", "Peaky Blinders is a crime drama centred on a family of mixed Irish Traveller and Romani origins based in Birmingham, England, starting in 1919, several months after the end of the First World War. It centres on the Peaky Blinders street gang and their ambitious, cunning crime boss Tommy Shelby (Murphy).", now(), 2);
insert into film values (21, "The Dictator", "Free", 5.1, "Comedy", 2000, 13, "3.png", "https://www.youtube.com/embed/TjLaLiwJdok", "Aladeen, a brutal dictator, travels to New York in order to address the United Nations Security Council. However, his plans go south when a hitman hired by his uncle, Tamir, kidnaps him.", now(), 3);
insert into film values (22, "Get On Up", "Free", 5.8, "Biography", 2000, 14, "4.png", "https://www.youtube.com/embed/bwEUvSKUpYk", "James Brown (Chadwick Boseman) was born in extreme poverty in 1933 South Carolina and survived abandonment, abuse and jail to become one of the most influential musicians of the 20th century. He joined a gospel group as a teenager, but the jazz and blues along the 'chitlin' circuit' became his springboard to fame.", now(), 4);
insert into film values (23, "Interview With the Vampire", "Subs", 4.9, "Horror", 2000, 15, "5.png", "https://www.youtube.com/embed/q8Oysn9I9K8", "Born as an 18th-century lord, Louis is now a bicentennial vampire, telling his story to an eager biographer. Suicidal after the death of his family, he meets Lestat, a vampire who persuades him to choose immortality over death and become his companion.", now(), 1);
insert into film values (24, "Pawn Sacrifice", "Free", 5.6, "History", 2000, 16, "6.png", "https://www.youtube.com/embed/fD2ZARxmpt0", "American chess legend Bobby Fischer (Tobey Maguire) and Soviet Grandmaster Boris Spassky (Liev Schreiber) enthrall the world with their intense battle of wills and strategy during the 1972 World Chess Championship.", now(), 2);
insert into film values (25, "Operation Finale", "Free", 4, "Drama", 2000, 13, "7.png", "https://www.youtube.com/embed/9ACZaJz9t-E", "Fifteen years after the end of World War II, a team of top-secret Israeli agents travels to Argentina to track down Adolf Eichmann, the Nazi officer who masterminded the transportation logistics that brought millions of innocent Jews to their deaths in concentration camps.", now(), 3);
insert into film values (26, "Denial", "Subs", 4.5, "Drama", 2000, 14, "8.png", "https://www.youtube.com/embed/lPD_LoQHBu0", "In 1993 Deborah Lipstadt and Penguin Books published `Denying the Holocaust'. Two years later the English author David Irving sued her for libel on the grounds that her book had ruined his once well-regarded career as an historian by accusing him of deliberately distorting historical facts.", now(), 4);
insert into film values (27, "Luce", "Free", 4.2, "Drama", 2000, 15, "9.png", "https://www.youtube.com/embed/2_Zer9iT4FY", "Luce, a bright student, gets tormented by his disgruntled history teacher. However, he stays focused on protecting his reputation, not only in high school but also in the eyes of his adoptive parents.", now(), 1);
insert into film values (28, "Fighting with My Family", "Free", 5.9, "Biography", 2000, 16, "10.png", "https://www.youtube.com/embed/WqF3VTv0cqU", "Born into a tight-knit wrestling family, Paige and her brother Zak are ecstatic when they get the once-in-a-lifetime opportunity to try out for the WWE. But when only Paige earns a spot in the competitive training program, she must leave her loved ones behind and face this new cutthroat world alone.", now(), 2);
insert into film values (29, "Footloose", "Subs", 4.2, "Drama", 2000, 13, "11.png", "https://www.youtube.com/embed/P4narQca4Oc", "Teenager Ren and his family move from the city to a small town. He's in for a culture shock and can't quite believe that he's living in a place where rock music and dancing are illegal.", now(), 3);
insert into film values (30, "Swimming for Gold", "Free", 4.6, "Drama", 2000, 14, "12.png", "https://www.youtube.com/embed/7cq4TdLSKvc", "Young elite swimmer Claire is sent to Australia to coach a boys swimming team, where she must overcome an old rival and a secret fear to save the swimming camp from closing.", now(), 4);
